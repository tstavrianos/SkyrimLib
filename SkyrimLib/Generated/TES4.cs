...
namespace SkyrimLib
{
    ...
    {
        public static readonly Signature FieldType = Signature.FromString("TES4");
        ...
        internal TES4(IReader headerReader, IReader dataReader) : base(headerReader, dataReader)
        {
            ...
            this.ONAM = this.Fields.FirstOrDefault(x => x.Type == TES4_ONAM.FieldType) as TES4_ONAM;
            this.INTV = this.Fields.FirstOrDefault(x => x.Type == TES4_INTV.FieldType) as TES4_INTV;
